...
func NewListCommand() *cobra.Command {
	...
	return fctl.NewCommand("list",
		...
		fctl.WithStringFlag(c.accountFlag, "", "Filter by account"),
		fctl.WithStringFlag(c.destinationFlag, "", "Filter by destination account"),
		fctl.WithStringFlag(c.endTimeFlag, "", "Include only transactions before this date"),
		fctl.WithStringFlag(c.startTimeFlag, "", "Include only transactions after this date"),
		fctl.WithStringFlag(c.sourceFlag, "", "Filter by source account"),
		fctl.WithStringFlag(c.referenceFlag, "", "Filter by reference"),
