...
replace github.com/numary/membership-api/client v0.0.0-00010101000000-000000000000 => github.com/numary/membership-api/client v0.0.0-20220911122658-b8087892ffcc
