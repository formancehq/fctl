...
func (d DeleteAuthenticationProviderResponse) MarshalJSON() ([]byte, error) {
...
func (d *DeleteAuthenticationProviderResponse) GetHTTPMeta() components.HTTPMetadata {
	if d == nil {
...
func (d *DeleteAuthenticationProviderResponse) GetError() *components.Error {
	if d == nil {
		return nil
	}
	return d.Error
