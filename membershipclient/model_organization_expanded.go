...
func NewOrganizationExpanded(name string, defaultPolicyID NullableInt32, id string, ownerId string) *OrganizationExpanded {
...
func (o *OrganizationExpanded) GetDefaultPolicyID() int32 {
...
func (o *OrganizationExpanded) GetDefaultPolicyIDOk() (*int32, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *OrganizationExpanded) SetDefaultPolicyID(v int32) {
