...
func NewRootCommand(version string) *cobra.Command {
	...
	root.AddCommand(newCloudStacksCommand("cloud_stacks", false))
	root.AddCommand(newCloudStacksCommand("stack", true))
	root.AddCommand(newCloudStacksCommand("stacks", true))
