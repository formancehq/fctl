...
func NewListCommand() *cobra.Command {
	...
	return fctl.NewCommand("list",
		...
		fctl.WithShortDescription("List volumes and balances for a time period (OOT–PIT)"),
		...
		fctl.WithIntFlag(c.groupByFlag, 0, "Group by address segment level"),
		fctl.WithStringFlag(c.addressFlag, "", "Filter accounts by address"),
