...
func LoadCurrentProfile(cmd *cobra.Command, cfg Config) (*Profile, error) {
...
func LoadAndAuthenticateCurrentProfile(cmd *cobra.Command, cfg Config) (*Profile, client.RelyingParty, error) {
	...
	return profile, relyingParty, nil
}
