...
func NewPolicyData(name string) *PolicyData {
	this := PolicyData{}
	this.Name = name
	return &this
}
...
func (o *PolicyData) GetName() string {
	if o == nil {
		var ret string
		return ret
	}
...
func (o *PolicyData) GetNameOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
	return &o.Name, true
...
func (o *PolicyData) SetName(v string) {
	o.Name = v
}

// GetDescription returns the Description field value if set, zero value otherwise.
func (o *PolicyData) GetDescription() string {
...
// and a boolean to check if the value has been set.
func (o *PolicyData) GetDescriptionOk() (*string, bool) {
	if o == nil || IsNil(o.Description) {
		return nil, false
	}
...
func (o *PolicyData) HasDescription() bool {
	if o != nil && !IsNil(o.Description) {
		return true
	}
...
func (o *PolicyData) SetDescription(v string) {
	o.Description = &v
}
